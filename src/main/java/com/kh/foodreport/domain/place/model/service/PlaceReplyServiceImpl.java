...
public class PlaceReplyServiceImpl implements PlaceReplyService{
	...
	public void updateReply(Long replyNo, PlaceReplyDTO placeReply, Long memberNo) {
		...
		GlobalValidator.validateNo(replyNo, "유효하지 않은 댓글 번호입니다.");
	...
	public void saveReplyLike(Long replyNo, Long memberNo) {
		...
		int replyCount = placeReplyMapper.countByReplyNo(replyNo);
	...
	public void deleteReplyLike(Long replyNo, Long memberNo) {
		...
		int result = placeReplyMapper.deleteReplyLike(placeReplyLike);
